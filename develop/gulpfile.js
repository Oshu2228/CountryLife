...
config.paths = {
  ...
  //生成先
  dest: "../wp-content/themes/dev_thema/",
...
gulp.task('watch', gulp.series(creflalogo, gulp.parallel(buildSass, buildPug, buildJs, buildJsVendor, buildStatic, buildImage, buildfonts), gulp.series(startBrowserSync, watchBuild)));
